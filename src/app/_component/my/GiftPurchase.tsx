...
import LikelionBottomSheet from "./LikelionBottomSheet";
      ...
      <div className={styles.pageContainer}>
        ...
        {selectedGift.type === "상품" ? (
          ...
          <div style={{ marginTop: "3.4rem" }}>
            <p className={styles.title}>TO. {selectedGift.메뉴이름}</p>
            <p className={styles.letterText}>{selectedGift.편지}</p>
          </div>
        )}
        <button className={styles.purchaseBtn} onClick={() => openPopup(selectedGift)}>
          구매하기
        </button>
        {isPopupOpen && selectedGift.type === "멋사" && (
          <LikelionBottomSheet
